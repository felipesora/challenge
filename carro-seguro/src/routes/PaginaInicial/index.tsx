import mulherCarro from '../../assets/images/mulher-carro.png';
import icon24h from '../../assets/images/icone-24horas.png';
import iconCarro from '../../assets/images/icone-carro.png';
import iconFerramentas from '../../assets/images/icone-ferramentas.png';
import iconRating from '../../assets/images/icone-rating.png';
import iconEngrenagem from '../../assets/images/icone-engrenagem.png';
import iconInovacao from '../../assets/images/icone-inovação.png';
import './style.css';
        ...
        <div id="container_main">
            <div id="container_quem_somos">
                ...
                <div className="texto_imagem">
                    ...
                    <img src={mulherCarro} alt="Mulher dentro carro" className="imagem01"/>
                </div>
            </div>
            <div id="container_serviços">
                ...
                <ul className="lista_main">
                    <li className="li_main">
                        <img src={icon24h} alt="Ícone 24 horas" className="icone_li"/>
                        <div>
                    ...
                    <li className="li_main">
                        <img src={iconCarro} alt="Ícone de um carro" className="icone_li"/>
                        <div>
                    ...
                    <li className="li_main">
                        <img src={iconFerramentas} alt="Ícone de ferramentas" className="icone_li"/>
                        <div>
            ...
            <div id="container_escolher_porto">
                ...
                <ul className="lista_main">
                    <li className="li_main">
                        <img src={iconRating} alt="Ícone de uma estrela dentro de um quadrado" className="icone_li"/>
                        <div>
                    ...
                    <li className="li_main">
                        <img src={iconEngrenagem} alt="Ícone de uma mão segurando uma engrenagem " className="icone_li"/>
                        <div>
                    ...
                    <li className="li_main">
                        <img src={iconInovacao} alt="Ícone de uma cabeça com uma lâmpada" className="icone_li"/>
                        <div>
